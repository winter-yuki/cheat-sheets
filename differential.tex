...
\begin{itemize}
	...
	\begin{tabular}{l}
		...
		\end{tabular}
		\\
		//TO DO : 1)в полных диф. (есть еще +1 метод с фиксир. точкой) 2)инт. множ. 3) Дарбу \\
		\begin{tabular}{|l|}
			\hline
		...
		\begin{tabular}{|l|}
			\hline
			\textbf{Интегрирующий меожитель $\mu$}: \\
		 ...
		 $\omega = x \pm y$ \qquad $\omega = \pm \frac{x}{y}$ \qquad $\omega = \pm \frac{y}{x}$ \\
